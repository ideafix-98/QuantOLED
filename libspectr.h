...
/** \brief Free a device handle 
    ...
    \parblock
    This pointer should not be NULL - provide the address of a valid uintptr_t variable (containing a handle previously initialized by connectToDeviceBySerial() or connectToDeviceByIndex())
    \endparblock
...
void clearDevicesInfo(DeviceInfo_t *devices);
